...
Funcionalidade: US003 Disponibilizar Ingressos
  ...
  Cenario: US003 Deve mostrar mensagem de erro se não for selecionado um evento
  ...
  Cenario: US003 Deve mostrar mensagem de erro se não for informada data de inicio
    Dado que seleciono um evento para criar um periodo de venda
    E que nao informo data de inicio
    E que informo data de fim
    Quando salvar o periodo de venda
    Entao deve mostrar a mensagem "Informe a data de início."

  Cenario: US003 Deve mostrar mensagem de erro se não for informada data de fim
    Dado que seleciono um evento para criar um periodo de venda
